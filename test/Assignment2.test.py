import unittest
from src.Assignment2.util import expr,StringType,IntegerType,StructType,\
    StructField,SparkSession,pivot_fun, unpivot_fun
...
class MyTestCase(unittest.TestCase):
    ...
    def tearDownClass(cls):
        cls.spark.stop()
    def test_pivot_fun(self):
        df = self.spark.createDataFrame(data=data, schema=schema)
        result_df=pivot_fun(df)
